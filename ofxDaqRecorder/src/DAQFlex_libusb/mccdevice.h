...
class MCCDevice : public ofThread
{
    public:
        ...
        void startBackgroundTransfer(unsigned int sampleRate, unsigned int timeout, unsigned int bulkTxLength, dataBuffer* buffer);
    ...
    private:
		...
		unsigned short getBulkPacketSize(unsigned char* data, int data_length);
